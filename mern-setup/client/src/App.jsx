...
import PickupList from "./PickUpAddressPage/PickupList";
import PickupDetails from "./PickUpAddressPage/PickupDetails";
    ...
    <Router>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/details/:parcelId" element={<PickupDetails/>} />
